module my_fxn
   ...
   contains        
      ...
      subroutine commonpart(p3_0, p4_0,cos_theta,eta, k_v,P3_v, p4_v, s13, s14, s23, s24) ! The result generated by Mathematica is composed of s12,
         ...
         s13 = m**2- 2*dot_vec(k1,p3)  ! Defination of mandelstam variable in 2 to 3 process
         s14 = m**2- 2*dot_vec(k1,p4)  ! where we ingnore the mass of the initial particles
